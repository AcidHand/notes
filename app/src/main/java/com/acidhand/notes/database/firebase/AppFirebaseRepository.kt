package androis.example.notes.database.firebase

import androidx.lifecycle.LiveData
import androis.example.notes.database.DatabaseRepository
import androis.example.notes.models.AppNote
import androis.example.notes.utilits.*
            ...
            AUTH.signInWithEmailAndPassword(EMAIL, PASSWORD)
                ...
                .addOnFailureListener {
                    AUTH.createUserWithEmailAndPassword(EMAIL, PASSWORD)
                        ...
                        .addOnFailureListener { onFail(it.toString()) }
                }
        }
    }
